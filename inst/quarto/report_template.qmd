...
if (!is.null(params$contrasts)) {
  # TODO
  usagePlot(
    object = temp2, # TODO pe
    assays = list(ptm = "ptm", variant = "variant"),
    model = c(factor = "~0 + group", factor2 = "~group", factor3 = "~ group + extraction_efficiency"), # TODO purrr::set_names(params$design_formula, params$design_formula_names)
